    ...
    <>
      <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'> 
            ...
            <a aria-label='cv-download' href="/Inderpal-Singh-Resume.pdf" download className='px-10 py-3 border bg-white rounded-full border-gray-500  text-wrap flex items-center gap-2 dark:text-black'>my resume <img loading="lazy" src={downloadIcon} alt="" className='w-4'/></a>
        </div>
      </div>
    </>
  )
